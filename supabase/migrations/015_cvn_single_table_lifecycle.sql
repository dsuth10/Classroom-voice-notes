...
-- Single table-backed lifecycle on cvn_outbound_items (eliminating duplicate PGMQ queue writes for v2)

BEGIN;

-- Update cvn_submit_outbound_item to store item in cvn_outbound_items table without dual PGMQ write
...
BEGIN
    ...
    -- 6. Insert Into cvn_outbound_items Table (Single Table Source of Truth)
