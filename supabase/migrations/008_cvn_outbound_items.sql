...
BEGIN
    ...
    -- 3. Stale Timestamp Check (5 min limit)
    IF p_signed_at < (now() - INTERVAL '5 minutes') THEN
        RAISE EXCEPTION 'timestamp_stale: signed_at is older than 5 minutes'
            USING ERRCODE = '22007';
    END IF;
...
GRANT EXECUTE ON FUNCTION public.cvn_submit_outbound_item TO authenticated;
